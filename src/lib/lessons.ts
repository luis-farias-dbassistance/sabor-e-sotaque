...
export const INITIAL_DATA: Record<string, Module> = {
  "1": {
    ...
    vocabulary: [
      { word_pt: "bem-vindo", word_es: "bienvenido" },
      { word_pt: "cardápio", word_es: "carta / menú" },
      { word_pt: "mesa", word_es: "mesa" },
      { word_pt: "terraço", word_es: "terraza" },
      { word_pt: "garçom", word_es: "garzón / mesero" },
      { word_pt: "reserva", word_es: "reserva" },
      { word_pt: "conta", word_es: "la cuenta" },
      { word_pt: "cartão", word_es: "tarjeta" },
      { word_pt: "prato", word_es: "plato" },
      { word_pt: "bebida", word_es: "bebida" },
      { word_pt: "água com gás", word_es: "agua con gas" },
      { word_pt: "água sem gás", word_es: "agua sin gas" },
      { word_pt: "gelo", word_es: "hielo" },
      { word_pt: "sobremesa", word_es: "postre" },
      { word_pt: "gorjeta", word_es: "propina" },
    ]
  },
  "2": {
    id: "2",
  ...
  "5": {
    ...
    vocabulary: [
      { word_pt: "hospedagem", word_es: "alojamiento" },
      { word_pt: "hotel", word_es: "hotel" },
      { word_pt: "pousada", word_es: "hostal / posada" },
      { word_pt: "cabana", word_es: "cabaña" },
      { word_pt: "quarto", word_es: "habitación" },
      { word_pt: "cama", word_es: "cama" },
      { word_pt: "reserva", word_es: "reserva" },
      { word_pt: "recepção", word_es: "recepción" },
      { word_pt: "check-in", word_es: "check-in" },
      { word_pt: "check-out", word_es: "check-out" },
      { word_pt: "diária", word_es: "tarifa diaria" },
      { word_pt: "café da manhã", word_es: "desayuno" },
      { word_pt: "toalha", word_es: "toalla" },
      { word_pt: "banheiro", word_es: "baño" },
      { word_pt: "chuveiro", word_es: "ducha" },
      { word_pt: "senha do wi-fi", word_es: "contraseña del wi-fi" },
      { word_pt: "chave / cartão de acesso", word_es: "llave / tarjeta de acceso" },
      ...
      { word_pt: "disponibilidade", word_es: "disponibilidad" },
      { word_pt: "acomodação", word_es: "acomodación" },
    ]
  },
  "6": {
    id: "6",
  ...
  "7": {
    ...
    vocabulary: [
      ...
      { word_pt: "disponibilidade", word_es: "disponibilidad" },
      { word_pt: "vaga", word_es: "cupo / lugar" },
      { word_pt: "pagamento", word_es: "pago" },
      { word_pt: "depósito", word_es: "depósito" },
      { word_pt: "transferência bancária", word_es: "transferencia bancaria" },
      { word_pt: "cartão de crédito", word_es: "tarjeta de crédito" },
      { word_pt: "cartão de débito", word_es: "tarjeta de débito" },
      { word_pt: "comprovante", word_es: "comprobante" },
      { word_pt: "tarifa", word_es: "tarifa" },
      { word_pt: "orçamento", word_es: "cotización / presupuesto" },
      { word_pt: "desconto", word_es: "descuento" },
      ...
      { word_pt: "voucher", word_es: "voucher" },
      { word_pt: "seguro viagem", word_es: "seguro de viaje" },
    ]
  },
  "8": {
    id: "8",
  ...
  "10": {
    ...
    lessons: [
      ...
      { id: "10-11", phrase_pt: "Por favor, sigam o guia durante toda a caminhada.", phrase_es: "Por favor, sigan al guía durante toda la caminata.", context: "Instrucción de grupo.", speaker_role: "guide", imageUrl: "https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=800&q=80" },
      { id: "10-12", phrase_pt: "O caminho pode ser escorregadio.", phrase_es: "El camino puede ser resbaladizo.", context: "Advertencia del terreno.", speaker_role: "guide", imageUrl: "https://images.unsplash.com/photo-1542224566-6e85f2e6772f?auto=format&fit=crop&w=800&q=80" },
      { id: "10-13", phrase_pt: "Caminhem com cuidado nas pedras.", phrase_es: "Caminen con cuidado en las rocas.", context: "Prevención de accidentes.", speaker_role: "guide", imageUrl: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80" },
      { id: "10-14", phrase_pt: "Se alguém se sentir mal, avise imediatamente.", phrase_es: "Si alguien se siente mal, avise inmediatamente.", context: "Salud del grupo.", speaker_role: "guide", imageUrl: "https://images.unsplash.com/photo-1501555088652-021faa106b9b?auto=format&fit=crop&w=800&q=80" },
      { id: "10-15", phrase_pt: "Esta área é protegida.", phrase_es: "Esta área está protegida.", context: "Conservación ambiental.", speaker_role: "guide", imageUrl: "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=800&q=80" },
      { id: "10-16", phrase_pt: "O trekking é difícil?", phrase_es: "¿El trekking es difícil?", context: "Pregunta del turista.", speaker_role: "tourist", imageUrl: "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=800&q=80" },
      { id: "10-17", phrase_pt: "Precisamos de equipamento especial?", phrase_es: "¿Necesitamos equipamiento especial?", context: "Pregunta del turista.", speaker_role: "tourist", imageUrl: "https://images.unsplash.com/photo-1501555088652-021faa106b9b?auto=format&fit=crop&w=800&q=80" },
      { id: "10-18", phrase_pt: "Qual é a altitude deste lugar?", phrase_es: "¿Cuál es la altitud de este lugar?", context: "Pregunta del turista.", speaker_role: "tourist", imageUrl: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80" },
      { id: "10-19", phrase_pt: "Tem banheiro no parque?", phrase_es: "¿Hay baño en el parque?", context: "Pregunta del turista.", speaker_role: "tourist", imageUrl: "https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=800&q=80" },
      { id: "10-20", phrase_pt: "Podemos tirar fotos aqui?", phrase_es: "¿Podemos tomar fotos aquí?", context: "Pregunta del turista.", speaker_role: "tourist", imageUrl: "https://images.unsplash.com/photo-1542224566-6e85f2e6772f?auto=format&fit=crop&w=800&q=80" }
    ],
    vocabulary: [
      ...
      { word_pt: "mochila", word_es: "mochila" },
      { word_pt: "água", word_es: "agua" },
      { word_pt: "protetor solar", word_es: "protector solar" },
      { word_pt: "vento", word_es: "viento" },
      { word_pt: "frio", word_es: "frío" },
      ...
      { word_pt: "trilha marcada", word_es: "sendero marcado" },
      { word_pt: "percurso", word_es: "recorrido" },
      { word_pt: "calçado", word_es: "calzado" },
      { word_pt: "ônibus turístico", word_es: "bus turístico" },
    ]
  },
  "11": {
    id: "11",
  ...
  "m14": {
    ...
    vocabulary: [
      ...
      { word_pt: "torção", word_es: "torción / esguince" },
      { word_pt: "fratura", word_es: "fractura" },
      { word_pt: "sangramento", word_es: "sangrado" },
      { word_pt: "queimadura", word_es: "quemadura" },
      { word_pt: "desmaio", word_es: "desmayo" },
      { word_pt: "dor", word_es: "dolor" },
      { word_pt: "falta de ar", word_es: "falta de aire" },
      { word_pt: "tontura", word_es: "mareo" },
      { word_pt: "alergia", word_es: "alergia" },
      { word_pt: "ambulância", word_es: "ambulancia" },
      { word_pt: "hospital", word_es: "hospital" },
      { word_pt: "posto de saúde", word_es: "centro de salud" },
      { word_pt: "primeiros socorros", word_es: "primeros auxilios" },
      { word_pt: "evacuação", word_es: "evacuación" },
      { word_pt: "resgate", word_es: "rescate" },
      { word_pt: "equipe de emergência", word_es: "equipo de emergencia" },
      { word_pt: "telefone de emergência", word_es: "teléfono de emergencia" },
      { word_pt: "mantenha a calma", word_es: "mantenga la calma" },
      { word_pt: "atendimento médico", word_es: "atención médica" },
      { word_pt: "medicamento", word_es: "medicamento" },
    ],
    lessons: [
  ...
  "m15": {
    ...
    vocabulary: [
      { word_pt: "rafting", word_es: "rafting" },
      ...
      { word_pt: "rio", word_es: "río" },
      { word_pt: "correnteza", word_es: "corriente" },
      { word_pt: "embarque", word_es: "embarque" },
      { word_pt: "desembarque", word_es: "desembarque" },
      { word_pt: "guia", word_es: "guía" },
      { word_pt: "instruções de segurança", word_es: "instrucciones de seguridad" },
      { word_pt: "equipe de resgate", word_es: "equipo de rescate" },
      { word_pt: "nível de dificuldade", word_es: "nivel de dificultad" },
      { word_pt: "água fria", word_es: "agua fría" },
      { word_pt: "equilíbrio", word_es: "equilibrio" },
      { word_pt: "aventura", word_es: "aventura" },
      { word_pt: "adrenalina", word_es: "adrenalina" },
      { word_pt: "percurso", word_es: "recorrido / trayecto" },
      { word_pt: "travessia", word_es: "travesía" },
    ],
    lessons: [

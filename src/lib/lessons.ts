...
export const INITIAL_DATA: Record<string, Module> = {
  "1": {
    ...
    ,
      // Expressões Sprint 3
      { id: "m1-exp-01", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
      ...
      { id: "m1-exp-02", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Com licença.",
        phrase_es: "Con permiso. / Disculpe.",
        context: "Al pasar cerca del turista o interrumpir brevemente.",
        imageUrl: "/images/hospitalidad-bienvenido.jpg" },
      { id: "m1-exp-03", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        ...
        imageUrl: "/images/hospitalidad-bienvenido.jpg" },
      { id: "m1-exp-04", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Voltem sempre!",
        phrase_es: "¡Vuelvan siempre!",
        context: "Despedida que invita al turista a regresar.",
        imageUrl: "/images/hospitalidad-bienvenido.jpg" },
      { id: "m1-exp-05", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        ...
        imageUrl: "/images/hospitalidad-bienvenido.jpg" },
      { id: "m1-exp-06", moduleId: "1", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
  ...
  "5": {
    ...
    ,
      // Expressões Sprint 3
      { id: "m5-exp-01", moduleId: "5", lesson_type: "expression", difficulty: "básico", speaker_role: "receptionist",
      ...
      { id: "m5-exp-02", moduleId: "5", lesson_type: "expression", difficulty: "básico", speaker_role: "receptionist",
        phrase_pt: "Às suas ordens.",
        phrase_es: "A sus órdenes.",
        context: "Disponibilidad inmediata ante cualquier necesidad del turista.",
        imageUrl: "/images/hotel-checkin-hora.jpg" },
      { id: "m5-exp-03", moduleId: "5", lesson_type: "expression", difficulty: "básico", speaker_role: "receptionist",
        ...
        imageUrl: "/images/hotel-checkin-hora.jpg" },
      { id: "m5-exp-04", moduleId: "5", lesson_type: "expression", difficulty: "básico", speaker_role: "receptionist",
        phrase_pt: "Boa estadia!",
        phrase_es: "¡Buena estadía!",
        context: "Deseo al turista al momento del check-in o entrega de llaves.",
        imageUrl: "/images/hotel-checkin-hora.jpg" },
      { id: "m5-exp-05", moduleId: "5", lesson_type: "expression", difficulty: "básico", speaker_role: "receptionist",
  ...
  "10": {
    ...
    ,
      // Expressões Sprint 3
      { id: "m10-exp-01", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
      ...
      { id: "m10-exp-02", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Quase lá!",
        phrase_es: "¡Ya casi llegamos!",
        context: "Motivación al grupo cerca de la cima o del destino.",
        imageUrl: "/images/trekking-placeholder.jpg" },
      { id: "m10-exp-03", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Atenção ao degrau!",
        phrase_es: "¡Atención al escalón!",
        context: "Advertencia de seguridad ante un obstáculo en el sendero.",
        imageUrl: "/images/trekking-placeholder.jpg" },
      { id: "m10-exp-04", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        ...
        imageUrl: "/images/trekking-placeholder.jpg" },
      { id: "m10-exp-05", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        ...
        imageUrl: "/images/trekking-placeholder.jpg" },
      { id: "m10-exp-06", moduleId: "10", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
  ...
  "11": {
    ...
    ,
      // Expressões Sprint 3
      { id: "m11-exp-01", moduleId: "11", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
      ...
      { id: "m11-exp-02", moduleId: "11", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
      ...
      { id: "m11-exp-03", moduleId: "11", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Muito bem!",
        phrase_es: "¡Muy bien!",
        context: "Refuerzo positivo cuando el turista ejecuta bien una instrucción.",
        imageUrl: "/images/cabalgata-calma.jpg" },
      { id: "m11-exp-04", moduleId: "11", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
        phrase_pt: "Relaxem os ombros.",
        phrase_es: "Relajen los hombros.",
        context: "Corrección postural frecuente durante la cabalgata.",
        imageUrl: "/images/cabalgata-redeas.jpg" },
      { id: "m11-exp-05", moduleId: "11", lesson_type: "expression", difficulty: "básico", speaker_role: "guide",
